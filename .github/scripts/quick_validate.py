#!/usr/bin/env python3
"""Canonical Codex skill-creator quick validator."""
...
def validate_skill(skill_path):
    ...
    if unexpected:
        return False, f"Unexpected key(s) in SKILL.md frontmatter: {', '.join(sorted(unexpected))}. Allowed properties are: {', '.join(sorted(allowed))}"
